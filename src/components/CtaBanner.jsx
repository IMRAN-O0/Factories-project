      ...
      <div className="container-px mx-auto">
        <Reveal>
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-l from-brand-600 to-brand-700 px-8 py-14 text-center shadow-lg md:px-16 md:py-20">
            ...
            <h2 className="relative text-balance text-2xl font-extrabold text-white md:text-4xl">{t('ctaBanner.title')}</h2>
            <p className="relative mx-auto mt-4 max-w-xl text-white/85">{t('ctaBanner.desc')}</p>
            <Link
              to="/booking"
