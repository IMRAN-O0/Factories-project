...
import { Plus, Trash2, Save, Download, GraduationCap, Users, Calendar, Award, BookOpen, CheckCircle } from 'lucide-react';
...
const EmployeeTrainingRecord = () => {
  ...
  const trainingTypes = ['برنامج تدريبي', 'ورشة عمل', 'ندوة', 'محاضرة', 'تدريب عملي', 'تدريب إلكتروني', 'تدريب خارجي', 'تأهيل جديد'];
  const departments = ['الإنتاج', 'الجودة', 'المستودع', 'الصيانة', 'الإدارة', 'الأمن', 'النقل', 'المختبر', 'الموارد البشرية'];
  ...
  const getAttendanceColor = (status) => {
    switch (status) {
      case 'حضر': return 'text-green-700 bg-green-100 border-green-300';
      case 'غاب': return 'text-red-700 bg-red-100 border-red-300';
      case 'حضر جزئياً': return 'text-yellow-700 bg-yellow-100 border-yellow-300';
      case 'انسحب': return 'text-gray-700 bg-gray-100 border-gray-300';
  ...
  const getResultColor = (result) => {
    switch (result) {
      case 'ناجح': return 'text-green-700 bg-green-100 border-green-300';
      case 'راسب': return 'text-red-700 bg-red-100 border-red-300';
      case 'يحتاج إعادة': return 'text-yellow-700 bg-yellow-100 border-yellow-300';
      case 'لم يختبر': return 'text-gray-700 bg-gray-100 border-gray-300';
      default: return 'text-gray-700 bg-gray-100 border-gray-300';
    }
  };
  ...
  const calculateTrainingStats = () => {
    ...
    const averageScore = formData.attendees.filter(att => att.score && !isNaN(att.score))
            ...
            <table className="w-full min-w-max">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">رقم الموظف</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">اسم الموظف</th>
                  ...
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">الحضور</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">الدرجة</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">النتيجة</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">رقم الشهادة</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">تاريخ الشهادة</th>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
          ...
          <div className="overflow-x-auto">
            <table className="w-full min-w-max">
              <thead className="bg-gray-50">
                <tr>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">رقم الجلسة</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">التاريخ</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">الوقت</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">الموضوع</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">المدة</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">المدرب</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">عدد الحضور</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">ملاحظات</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">حذف</th>
                </tr>
              </thead>
