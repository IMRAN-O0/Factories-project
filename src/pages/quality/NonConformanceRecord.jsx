...
const NonConformanceRecord = () => {
  ...
  const addItem = (category) => {
    const newItem = category === 'affectedItems' ? {
  ...
  const getSeverityColor = (severity) => {
    switch (severity) {
      ...
      case 'حرج': return 'text-red-700 bg-red-100 border-red-300';
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      case 'تحت المراجعة': return 'text-yellow-700 bg-yellow-100 border-yellow-300';
      case 'في التنفيذ': return 'text-blue-700 bg-blue-100 border-blue-300';
            ...
            <table className="w-full min-w-max">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">الكود</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">رقم الدفعة</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">الكمية</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">الموقع</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">التأثير</th>
            ...
            <table className="w-full min-w-max">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">الإجراء</th>
