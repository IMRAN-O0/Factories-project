...
const CorrectiveActionReport = () => {
  ...
  const getPriorityColor = (priority) => {
    switch (priority) {
      ...
      case 'عالي': return 'text-orange-700 bg-orange-100 border-orange-300';
      case 'عاجل': return 'text-red-700 bg-red-100 border-red-300';
  ...
  const getStatusColor = (status) => {
    switch (status) {
      case 'مفتوح': return 'text-blue-700 bg-blue-100 border-blue-300';
      ...
      case 'تحت التحقق': return 'text-purple-700 bg-purple-100 border-purple-300';
      case 'مغلق': return 'text-gray-700 bg-gray-100 border-gray-300';
      case 'مؤجل': return 'text-red-700 bg-red-100 border-red-300';
  ...
  const getEffectivenessColor = (effectiveness) => {
    switch (effectiveness) {
      case 'فعال': return 'text-green-700 bg-green-100 border-green-300';
      case 'فعال جزئياً': return 'text-yellow-700 bg-yellow-100 border-yellow-300';
      case 'غير فعال': return 'text-red-700 bg-red-100 border-red-300';
      case 'يحتاج مراجعة': return 'text-orange-700 bg-orange-100 border-orange-300';
      default: return 'text-gray-700 bg-gray-100 border-gray-300';
    }
  };
            ...
            <table className="w-full min-w-max">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">وصف الإجراء</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">المسؤول</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">التاريخ المستهدف</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">التاريخ الفعلي</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">الحالة</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">الأدلة</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">الموارد المطلوبة</th>
          ...
          <div className="overflow-x-auto">
            <table className="w-full min-w-max">
              <thead className="bg-gray-50">
                <tr>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">#</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">طريقة التحقق</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">معايير النجاح</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">النتيجة</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">التاريخ</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">المحقق</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">ملاحظات</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">حذف</th>
                </tr>
              </thead>
          ...
          <div className="overflow-x-auto">
            <table className="w-full min-w-max">
              <thead className="bg-gray-50">
                <tr>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">#</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">تاريخ المراجعة</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">النتائج والملاحظات</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">تقييم الفعالية</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">الإجراء التالي</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">المسؤول</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">حذف</th>
                </tr>
              </thead>
                ...
                {formData.followUp.map((item, index) => (
                  <tr key={item.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-3 py-2">
                      ...
                      >
                        {effectivenessLevels.filter(level => level !== 'غير محدد').map(level => (
                          <option key={level} value={level}>{level}</option>
                        ))}
                      </select>
                    </td>
