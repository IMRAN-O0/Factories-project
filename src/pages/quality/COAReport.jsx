...
const CertificateOfAnalysis = () => {
  ...
  const parameters = ['المظهر العام', 'اللون', 'الرائحة', 'الطعم', 'الرطوبة', 'الحموضة', 'البروتين', 'الدهون', 'العد الكلي للبكتيريا', 'الخمائر والعفن'];
  ...
  const getStatusIcon = (status) => {
    switch (status) {
      case 'مطابق': return CheckCircle;
      case 'غير مطابق': return XCircle;
      case 'حدي': return AlertTriangle;
  ...
  const getConclusionColor = (conclusion) => {
    switch (conclusion) {
      case 'مطابق للمواصفات': return 'text-green-700 bg-green-100 border-green-300';
      case 'غير مطابق للمواصفات': return 'text-red-700 bg-red-100 border-red-300';
      case 'مطابق مع تحفظ': return 'text-yellow-700 bg-yellow-100 border-yellow-300';
      case 'يحتاج إعادة فحص': return 'text-orange-700 bg-orange-100 border-orange-300';
      default: return 'text-gray-700 bg-gray-100 border-gray-300';
    }
  };
      ...
      <div className="min-h-screen bg-white p-8 text-black print:p-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gray-100 p-4 mb-6 text-sm text-center">
            ...
            {formData.comments && (
              <div className="mt-2">{formData.comments}</div>
            )}
          </div>
            ...
            <table className="w-full min-w-max">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">المعامل</th>
                  <th className="px-3 py-2 text-right text-xs font-medium text-gray-700 uppercase tracking-wider">طريقة الفحص</th>
                    ...
                    <tr key={test.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-3 py-2">
                        <div className="flex items-center gap-2">
                          ...
                          <StatusIcon size={16} className={test.status === 'مطابق' ? 'text-green-600' : test.status === 'غير مطابق' ? 'text-red-600' : 'text-yellow-600'} />
                        </div>
                      </td>
                      <td className="px-3 py-2">
                        <input
